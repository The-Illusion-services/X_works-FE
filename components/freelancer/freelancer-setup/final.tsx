...
const FinalDetails = ({ handleBack, handleNext }: FinalDetailsProps) => {
  ...
  // Watch for changes in the profile_picture field and country
  const profilePicture = watch('profile_picture');
  const selectedCountry = watch('country');

  const [previewImageUrl, setPreviewImageUrl] = useState(() => {
    const existingImage = getValues('profile_picture');
    if (existingImage instanceof File) {
      return URL.createObjectURL(existingImage);
    }
    return null;
  });
    ...
    <>
      <main className="px-5 mb-36">
        <div className="w-full lg:max-w-xl mx-auto">
          ...
          <div className="bg-background mx-auto relative rounded-xl p-10 mt-9 pb-32 ">
            <div className="w-full space-y-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className={'w-full'}>
                      ...
                      <FormDescription>
                        <Text size={'1'}>Your First Name and Last Name</Text>
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="hidden mt-8 items-center gap-x-5">
                <div className="w-1/2">
                  <FormField
                    control={control}
                    name="date_of_birth"
                    render={({ field }) => (
                      <FormItem className="flex flex-col">
                        <FormLabel className="text-[#545756] text-sm font-normal font-circular mb-1">
                          Date of Birth
                        </FormLabel>
                        <Popover open={open} onOpenChange={setOpen}>
                          <PopoverTrigger
                            asChild
                            className="w-full bg-transparent hover:bg-white hover:text-[#7E8082] focus:bg-white"
                          >
                            <FormControl className="border border-gray-300 w-full dark:border-[#1D2739]">
                              ...
                              >
                                {field.value ? (
                                  ...
                                  <span className="font-circular text-base text-[#BEBEBE]">
                                    YY-MM-DD
                                  </span>
                                )}
                          ...
                          <PopoverContent className="w-auto p-0" align="start">
                            <Calendar
                              ...
                              classNames={{
                                dropdown_year:
                                  'focus:bg-white hover:bg-white active:bg-white',
                ...
                <div className="w-1/2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[#545756] font-normal font-circular text-sm">
                          Country
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          className="bg-white placeholder:font-circular border-gray-300 font-circular placeholder:text-[#BEBEBE] py-2"
              ...
              <div className="hidden mt-5 items-center gap-x-5">
                <div className="w-1/2">
                  <FormField
                    control={control}
                    name="state"
