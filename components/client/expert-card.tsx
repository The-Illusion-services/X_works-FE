...
const ExpertCard = ({
  ...
  title,
  location,
}: Partial<ExpertCardProps>) => {
  return (
    <>
      <div className="border border-[#E4E4E7] font-circular bg-white p-5 rounded-lg">
        <div className="flex items-center space-x-3">
          <Image src="/images/client/client.png" alt="client" width={100} height={100} className={"w-full h-full"} />
        ...
        <div className="py-5">
          ...
          <p className="text-[#7E8082] text-sm mt-2">
            I am a highly creative designer with over three years of experience
            in the design industry. I have a deep understanding...
          </p>
        </div>

        <Link href={ApplicationRoutes.PROPOSAL} className="">
          <Button className="w-full bg-white hover:bg-white focus:bg-white border border-primary rounded-md text-primary">
            Book a consultation
          </Button>
        </Link>
      </div>
